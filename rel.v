...
Lemma unary_proper_t S (f: S -> S) b:
...
Lemma unary_proper_T S (f: S -> S) b g:
  unary_ctx f <= t b -> forall R, Proper (T b g R ==> T b g R) f.
Proof. intros H R x x' Hx. apply (fT_T H). now apply (in_unary_ctx f). Qed.
Lemma unary_proper_bT S (f: S -> S) b g:
  unary_ctx f <= t b -> forall R, Proper (bT b g R ==> bT b g R) f.
Proof. intros H R x x' Hx. apply (fbT_bT H). now apply (in_unary_ctx f). Qed.

Global Instance unary_proper_Tctx S (f: S -> S) b R:
  Proper (T b (unary_ctx f) R ==> T b (unary_ctx f) R) f.
Proof. intros x x' Hx. apply (fTf_Tf b). now apply (in_unary_ctx f). Qed.
...
(** if it is below [t], then the function [f] always preserves [t R], [bt R], [T f R], [bT f R] *)
Lemma binary_proper_t S (f: S -> S -> S) b:
...
Lemma binary_proper_T S (f: S -> S -> S) b g:
  binary_ctx f <= t b -> forall R, Proper (T b g R ==> T b g R ==> T b g R) f.
Proof. intros H R x x' Hx y y' Hy. apply (fT_T H). now apply (in_binary_ctx f). Qed.
Lemma binary_proper_bT S (f: S -> S -> S) b g:
  binary_ctx f <= t b -> forall R, Proper (bT b g R ==> bT b g R ==> bT b g R) f.
Proof. intros H R x x' Hx y y' Hy. apply (fbT_bT H). now apply (in_binary_ctx f). Qed.

Global Instance binary_proper_Tctx S (f: S -> S -> S) b R:
  Proper (T b (binary_ctx f) R ==> T b (binary_ctx f) R ==> T b (binary_ctx f) R) f.
Proof. intros x x' Hx y y' Hy. apply (fTf_Tf b). now apply (in_binary_ctx f). Qed.
...
(** if it is below [t], then the function [f] always preserves [t R], [bt R], [T f R], [bT f R] *)
Lemma ternary_proper_t S (f: S -> S -> S -> S) b:
...
Lemma ternary_proper_T S (f: S -> S -> S -> S) b g:
  ternary_ctx f <= t b -> forall R, Proper (T b g R ==> T b g R ==> T b g R ==> T b g R) f.
Proof. intros H R x x' Hx y y' Hy z z' Hz. apply (fT_T H). now apply (in_ternary_ctx f). Qed.
Lemma ternary_proper_bT S (f: S -> S -> S -> S) b g:
  ternary_ctx f <= t b -> forall R, Proper (bT b g R ==> bT b g R ==> bT b g R ==> bT b g R) f.
Proof. intros H R x x' Hx y y' Hy z z' Hz. apply (fbT_bT H). now apply (in_ternary_ctx f). Qed.

Global Instance ternary_proper_Tctx S (f: S -> S -> S -> S) b R:
  Proper (T b (ternary_ctx f) R ==> T b (ternary_ctx f) R ==> T b (ternary_ctx f) R ==> T b (ternary_ctx f) R) f.
Proof. intros x x' Hx y y' Hy z z' Hz. apply (fTf_Tf b). now apply (in_ternary_ctx f). Qed.
