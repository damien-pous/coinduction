...
Section s.
  ...
  #[export] Instance sub_bChain {R} {CR: Chain b R}: subrelation (b R) R.
  Proof. exact (b_chain (b:=b)). Qed.
  #[export] Instance sub_gfp_Chain {R} {CR: Chain b R}: subrelation (gfp b) R.
  Proof. exact (gfp_chain (b:=b)). Qed.
  
  Proposition Reflexive_chain: (forall R, Chain b R -> Reflexive R -> Reflexive (b R)) -> forall R, Chain b R -> Reflexive R.
  Proof. apply tower, inf_closed_reflexive. Qed.  
  Proposition Symmetric_chain: (forall R, Chain b R -> Symmetric R -> Symmetric (b R)) -> forall R, Chain b R -> Symmetric R.
  Proof. apply tower, inf_closed_symmetric. Qed.  
  Proposition Transitive_chain: (forall R, Chain b R -> Transitive R -> Transitive (b R)) -> forall R, Chain b R -> Transitive R.
  ...
  Proposition Proper_chain n f:
    (forall R, Chain b R -> Proper (respectful_iter n R R) f -> Proper (respectful_iter n (b R) (b R)) f) ->
    forall R, Chain b R -> Proper (respectful_iter n R R) f.
